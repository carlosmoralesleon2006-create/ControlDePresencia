...
class Registro(db.Model):
    ...
    trabajador = db.relationship('Empleado', backref='fichajes', lazy=True)
...
class Incidencia(db.Model):
    ...
    id_trabajador = db.Column(db.Integer, db.ForeignKey('empleado.id'), nullable=False)
    trabajador = db.relationship('Empleado', backref='incidencias_reportadas', lazy=True)
...
class Dia(db.Model):
    ...
    franjas = db.relationship('FranjaHoraria', backref='dia_obj', lazy=True)
